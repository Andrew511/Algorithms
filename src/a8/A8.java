...
class A8 {
  ...
  static void part3(int seed, int algo_num) {
    ...
    while (array_size <= MAX_N) {
      ...
      if (algo_num == 1) { //excel(google sheets at least) is able to delimit cells on commas and newlines
        System.out.println(array_size + "," + Sort.algo1(array));
      } else if (algo_num == 2) {
        System.out.println(array_size + "," + Sort.algo2(array));
      } else if (algo_num == 3) {
        System.out.println(array_size + "," + Sort.algo3(array));
      } else {
